        ...
        return (
            ...
            <div className="edit">
                ...
                <form action={`/places/edit/${place._id}?_method=put`} method="POST">
                  Name: <input type="text" name="name" defaultValue={place.name}/><br/>
                  Description:  <textarea name="description" defaultValue={place.description}/><br/>
                  ...
                  <br/>
                  Image URL: <input type="text" name="image" defaultValue={place.image}/> <br/>
                  Website URL: <input type="text" name="website" defaultValue={place.website}/> <br/>
                  Street Address:  <input type="text" name="address" defaultValue={place.address}/> <br/>
                  Type: <input type="text" name="type" defaultValue={place.type}/> <br/>
                  ...
                  <input type="text" name="keywords" defaultValue={place.keywords[2]}/><br/>
